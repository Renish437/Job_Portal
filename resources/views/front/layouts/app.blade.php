...
<head>
	...
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/trumbowyg@2.30.0/dist/ui/trumbowyg.min.css">
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">HamroJob</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					<li class="nav-item">
						<a class="nav-link {{ Request::routeIs('home') ? 'text-primary-1' : '' }}" aria-current="page" href="{{ route('home') }}">Home</a>
					</li>	
					<li class="nav-item">
						<a class="nav-link {{ Request::routeIs('jobs')?'text-primary-1': '' }} " aria-current="page" href="{{ route('jobs') }}">Find Jobs</a>
					</li>										
				</ul>
				@if(!Auth::check())
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="profilePicture" action="" method="POST" >
