                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="job_nature" id="job_nature" class="form-select">
                                        ...
                                        json_encode($item)
                                        <option value="{{ $item->id }}" {{ ($job->job_type_id==$item->id) ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                        @endforeach
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input {{ ($job->is_featured==1)?'checked':'' }} class="form-check-input" type="checkbox" value="1" id="isFeatured" name="is_featured">
