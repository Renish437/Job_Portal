            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <div class="card-body  p-4">
                        <h3 class="fs-4 mb-1">User / Create</h3>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="designation" id="designation" placeholder="Designation" class="form-control" value="{{ old('designation') }}">
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Mobile</label>
                            <input type="text" name="mobile" id="mobile" placeholder="Mobile" class="form-control" value="{{ old('mobile') }}">
                        </div>                        
                    </div>
